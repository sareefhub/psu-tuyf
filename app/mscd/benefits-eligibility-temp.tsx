...
const eligibilityData = [
  {
    labelTh: "เป็นผู้ที่สมัครโครงการรับนักศึกษาคณะวิทยาศาสตร์และเทคโนโลยี TCAS1 รอบ 1/1 หรือ 1/2 (แฟ้มสะสมผลงาน) สาขาคณิตศาสตร์และวิทยาการคอมพิวเตอร์ โดยผ่านโครงการ ดังนี้:",
    labelEn: "Applied for Faculty of Science and Technology admission in TCAS Round 1 (1/1 or 1/2 Portfolio) for Mathematics and Computer Science through one of the following projects:",
    subItemsTh: [
  ...
  {
    labelTh: "กำลังศึกษาในระดับชั้นมัธยมศึกษาปีที่ 6 หรือสำเร็จการศึกษาจากโรงเรียนเอกชนสอนศาสนาอิสลามในสามจังหวัดชายแดนใต้ (ปัตตานี ยะลา และนราธิวาส)",
    labelEn: "Currently in Grade 12 (M.6) or graduated from an Islamic private school in the three southern border provinces (Pattani, Yala, Narathiwat)."
  },
  {
    labelTh: "มีผลการเรียนสะสม (GPAX) ไม่ต่ำกว่า 3.00 และผลการเรียนเฉลี่ย 5 ภาคการศึกษาวิชาคณิตศาสตร์ไม่ต่ำกว่า 2.50",
    labelEn: "Cumulative GPAX of at least 3.00, and a 5-semester average grade in Mathematics of at least 2.50."
  },
  {
    labelTh: "เป็นผู้มีสุขภาพกายและจิตเป็นปกติ ไม่เป็นโรคติดต่อหรือโรคร้ายแรงที่เป็นอุปสรรคต่อการเรียน",
    labelEn: "In good physical and mental health, with no contagious or severe illnesses that obstruct studies."
  },
  {
    labelTh: "เป็นผู้มีใจรักในวิชาคณิตศาสตร์และมีเจตคติที่ดีต่ออาชีพที่เกี่ยวกับการศึกษา",
    labelEn: "Possess a passion for mathematics and a positive attitude towards education-related careers."
  },
  {
    labelTh: "เป็นผู้มีความรับผิดชอบ มีความเป็นผู้นำ สำนึกรักบ้านเกิด และอยากพัฒนาบ้านเกิดของตนเอง หรือ ชุมชนในพื้นที่สามจังหวัดชายแดนใต้",
    labelEn: "Responsible, possessing leadership qualities, local consciousness, and a desire to develop their hometown or community in the three southern border provinces."
  },
  {
...
const obligationsData = [
  {
    labelTh: "เป็นผู้มีความขยันหมั่นเพียรในการศึกษาและมีความประพฤติดี โดยในทุกภาคการศึกษาจะต้องรายงานผลการศึกษาและได้รับการรับรองความประพฤติจากอาจารย์ที่ปรึกษา ประธานหลักสูตร หัวหน้าสาขาวิชาคณิตศาสตร์และวิทยาการคอมพิวเตอร์ ตามแบบฟอร์มที่โครงการทุนกำหนด",
    labelEn: "Show diligence in studies and good conduct. In each semester, recipients must submit academic results and conduct certifications from their advisor, program chair, and department head according to the form specified by the scholarship project."
  },
  {
    labelTh: "ลงทะเบียนเรียนตามแผนการศึกษาของหลักสูตร หากนอกเหนือจากนั้น จะต้องได้รับความเห็นชอบจากคณะกรรมการโครงการ และมีผลการเรียนตามที่กำหนด ดังนี้:",
    labelEn: "Register according to the program curriculum plan. Any deviation must be approved by the project committee. Academic performance must meet the following criteria:",
    subItemsTh: [
      "มีผลการเรียนในแต่ละภาคการศึกษา (GPA) ไม่ต่ำกว่า 2.50",
      "มีผลการเรียนสะสม (GPAX) ไม่ต่ำกว่า 2.50"
    ],
    subItemsEn: [
      "GPA in each semester not less than 2.50",
      "Cumulative GPAX not less than 2.50"
    ]
  }
]
      ...
      <div className="mx-auto max-w-6xl px-6 space-y-10">
          ...
          <div className="bg-card border border-border/60 rounded-3xl p-8 sm:p-10 shadow-sm">
            ...
            <div className="space-y-4 max-h-[400px] overflow-y-auto pr-2">
              {eligibilityData.map((req, index) => (
                <div key={index} className="space-y-2 border-b border-border/40 pb-3 last:border-b-0 last:pb-0">
                  ...
                  {req.subItemsTh && (
                    <ul className="pl-8 list-disc space-y-1">
                      {t(req.subItemsTh, req.subItemsEn).map((sub, sIdx) => (
                        <li key={sIdx} className="text-[10px] text-muted-foreground leading-relaxed">
                          {sub}
                        </li>
                      ))}
                    </ul>
        ...
        <div className="bg-card border border-border/60 rounded-3xl p-8 sm:p-10 shadow-sm">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-bold text-primary">
              {t("ข้อปฏิบัติสำหรับผู้ที่ได้รับเลือกเข้ารับทุน", "Obligations & Conditions for Recipients")}
            </h2>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {obligationsData.map((ob, index) => (
              <div key={index} className="bg-secondary/20 rounded-2xl p-5 border border-border/40 space-y-3">
                <div className="flex gap-3 items-start">
                ...
                {ob.subItemsTh && (
                  <ul className="pl-9 list-disc space-y-1.5">
                    {t(ob.subItemsTh, ob.subItemsEn).map((sub, sIdx) => (
                      <li key={sIdx} className="text-[10px] text-muted-foreground leading-relaxed font-semibold">
                        {sub}
                      </li>
                    ))}
                  </ul>
