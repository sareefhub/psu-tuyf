...
import { Award, BookOpen, Settings, CheckCircle } from "lucide-react"
  ...
  return (
    <section className="py-10 bg-background animate-fade-in">
      <div className="mx-auto max-w-7xl px-6">
        ...
        {/* เลย์เอาต์แสดงการ์ดหลักสูตร 2 รายวิชาหลัก */}
            ...
            <div className="flex gap-4 items-start relative z-10">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2 text-xs text-accent font-semibold pt-2">
                  ...
                  <span>ยกระดับการจัดการเรียนรู้วิถีใหม่</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex gap-4 items-start relative z-10">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2 text-xs text-primary font-semibold pt-2">
                  ...
                  <span>เน้นทักษะการปฏิบัติงานและการวิจัยในชั้นเรียน</span>
                </div>
              </div>
            </div>
          </div>
