...
/**
 * คอมโพเนนต์แสดงผลประกาศและจดหมายข่าวฝั่งกิจกรรมพัฒนานักเรียน
...
export function AnnouncementsSection() {
  ...
  const announcements = announcementKeys.map((key) => ({
    title: t(`studentImprovement.announcements.items.${key}.title`),
    date: t(`studentImprovement.announcements.items.${key}.date`),
