...
function PomHero() {
  ...
  return (
    <section className="bg-primary text-primary-foreground relative overflow-hidden py-16 lg:py-20 animate-fade-in">
      ...
      {/* วงแหวนแสงแผ่สีแอกเซนต์สำหรับคุมดีไซน์และโทนแสงให้สม่เสมอกันทุกหน้าย่อย */}
...
function ObjectivesSection() {
  const t = useT()
  const objectives = t("pom2024.objectivesList", { returnObjects: true }) as string[]
...
function ScheduleTimeline() {
  const t = useT()
  const schedule = t("pom2024.scheduleList", { returnObjects: true }) as Array<{ date: string; detail: string }>
...
function PostTestScores() {
  const images = [
    ...
    "/images/mscd/student-improvement/excellence-match-camp/pom-2024/post-test-2.png",
  ]
...
function ActivitiesGallery() {
  ...
  // รายการรูปภาพกิจกรรม 6 ภาพในอัลบั้มของปี 2024
  const images = [
    "/images/mscd/student-improvement/excellence-match-camp/pom-2024-gallery-1.png",
    "/images/mscd/student-improvement/excellence-match-camp/pom-2024-gallery-2.png",
    "/images/mscd/student-improvement/excellence-match-camp/pom-2024-gallery-3.png",
    "/images/mscd/student-improvement/excellence-match-camp/pom-2024-gallery-4.png",
    "/images/mscd/student-improvement/excellence-match-camp/pom-2024-gallery-5.png",
    "/images/mscd/student-improvement/excellence-match-camp/pom-2024-gallery-6.png",
  ]
  ...
  return (
    <section className="py-10 bg-background animate-fade-in">
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center max-w-2xl mx-auto mb-12 space-y-3">
          <h2 className="text-balance text-2xl font-bold tracking-tight text-primary sm:text-3xl">
            {t("pom2024.galleryTitle")}
          </h2>
          <p className="text-sm text-muted-foreground/80">
            ประมวลภาพกิจกรรมการอบรมเข้มเตรียมสอบ สอวน. วิชาคณิตศาสตร์ ประจำปี 2567
          </p>
        </div>
...
function PomScholarshipsContent() {
  ...
  const tabs = [
    { id: "objectives", key: "pom2024.tabs.objectives" },
    { id: "schedule", key: "pom2024.tabs.schedule" },
    { id: "announcement", key: "pom2024.tabs.announcement" },
    { id: "postTest", key: "pom2024.tabs.postTest" },
    { id: "gallery", key: "pom2024.tabs.gallery" },
  ] as const
