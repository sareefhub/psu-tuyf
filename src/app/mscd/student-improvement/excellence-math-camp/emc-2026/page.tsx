...
// คอมโพเนนต์หน้าย่อยสำหรับแสดงรายละเอียดย่อยโครงการ Excellence Math Camp 2026 (ปี 2569)
      ...
      <section className="py-24 bg-background">
        <div className="mx-auto max-w-4xl px-6 text-center space-y-4">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground/80 max-w-lg mx-auto">
            ขณะนี้รายละเอียดการอบรมและกิจกรรมของโครงการ Excellence Math Camp ประจำปี 2569 กำลังอยู่ระหว่างการรวบรวมและจะอัปเดตให้แสดงผลในเร็วๆ นี้
          </p>
        </div>
      </section>
