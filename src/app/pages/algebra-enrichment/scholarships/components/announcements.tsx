      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
          <h2 className="text-balance text-2xl font-bold tracking-tight text-primary sm:text-3xl">
            {t("algebraScholarships.announcements.title")}
          </h2>
          <p className="text-sm text-muted-foreground/80">
            {t("algebraScholarships.announcements.desc")}
          </p>
        </div>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div className="space-y-1">
                    <h3 className="font-bold text-primary text-sm sm:text-base leading-snug group-hover:text-accent transition-colors">
                      {t(`algebraScholarships.announcements.items.${item.key}.title`)}
                    </h3>
                    <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-muted-foreground">
                      <span className="flex items-center gap-1">
                        <Calendar className="h-3.5 w-3.5" />
                        {t(`algebraScholarships.announcements.items.${item.key}.date`)}
                      </span>
          ...
          >
            ...
            >
                ...
                {previewPdf.url === "#" ? (
                  ...
                  <div className="text-center p-8 max-w-md space-y-4">
                    ...
                    <h4 className="font-bold text-primary text-base">
                      {t("algebraScholarships.announcements.noPdfTitle")}
                    </h4>
                    <p className="text-xs text-muted-foreground leading-relaxed">
                      {t("algebraScholarships.announcements.noPdfDesc")}
                    </p>
                  </div>
                ) : (
                  <>
                    ...
                    <div className="flex md:hidden flex-col justify-center items-center text-center p-6 max-w-sm space-y-6">
                      ...
                      <div className="space-y-2">
                        <h4 className="font-bold text-primary text-sm sm:text-base">
                          {t("algebraScholarships.announcements.pdfReadyTitle")}
                        </h4>
                        <p className="text-xs text-muted-foreground leading-relaxed px-4">
                          {t("algebraScholarships.announcements.pdfReadyDesc")}
                        </p>
                      </div>
                      ...
                      >
                        <Eye className="h-3.5 w-3.5" />
                        {t("algebraScholarships.announcements.pdfOpenBtn")}
                      </a>
                    </div>
                  </>
                )}
              ...
              <div className="p-3 bg-secondary/30 border-t border-border/40 text-2xs text-center text-muted-foreground">
                {t("algebraScholarships.announcements.footerHelp")}
              </div>
            </div>
          </button>
        )}
