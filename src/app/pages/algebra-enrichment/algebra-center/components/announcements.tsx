          ...
          >
            ...
            >
                ...
                {previewPdf.url === "#" ? (
                  ...
                  <div className="text-center p-8 max-w-md space-y-4">
                    ...
                    <h4 className="font-bold text-primary text-base">
                      {t("algebraCenter.announcements.noPdfTitle")}
                    </h4>
                    <p className="text-xs text-muted-foreground leading-relaxed">
                      {t("algebraCenter.announcements.noPdfDesc")}
                    </p>
                  </div>
                ) : (
                  <>
                    ...
                    <div className="flex md:hidden flex-col justify-center items-center text-center p-6 max-w-sm space-y-6">
                      ...
                      <div className="space-y-2">
                        <h4 className="font-bold text-primary text-sm sm:text-base">
                          {t("algebraCenter.announcements.pdfReadyTitle")}
                        </h4>
                        <p className="text-xs text-muted-foreground leading-relaxed px-4">
                          {t("algebraCenter.announcements.pdfReadyDesc")}
                        </p>
                      </div>
                      ...
                      >
                        <Eye className="h-3.5 w-3.5" />
                        {t("algebraCenter.announcements.pdfOpenBtn")}
                      </a>
                    </div>
                  </>
                )}
              ...
              <div className="p-3 bg-secondary/30 border-t border-border/40 text-2xs text-center text-muted-foreground">
                {t("algebraCenter.announcements.footerHelp")}
              </div>
            </div>
          </button>
        )}
