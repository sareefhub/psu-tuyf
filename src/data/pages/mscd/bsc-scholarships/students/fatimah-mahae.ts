...
export const fatimahProfile: StudentProfile = {
  slug: "fatimah-mahae",
  name: {
    th: "Fatimah Mahae",
    en: "Fatimah Mahae",
  },
  image: "/images/mscd/bsc-scholarships/fatimah-mahae/profile.png",
  role: {
  ...
  projectTitle: {
    th: "การศึกษาและพัฒนาแอปพลิเคชันโดยประยุกต์ใช้เครื่องมือปัญญาประดิษฐ์",
  ...
  award: {
    th: "รองชนะเลิศอันดับ 2 ประกวดผลงานสหกิจศึกษาและการศึกษาเชิงบูรณาการกับการทำงาน ประเภทนักศึกษาหลักสูตร CWIE สาขาวิชาวิทยาศาสตร์และเทคโนโลยี ที่มีโครงงานผลงานดีเด่น ระดับวิทยาเขตปัตตานี ประจำปี 2569",
    en: "2nd Runner-up in the Cooperative and Work-Integrated Education (CWIE) Project Contest, Science and Technology category, featuring outstanding project work at the Pattani Campus level, Year 2026.",
  },
  internship: {
    position: {
    ...
    location: {
      th: "บริษัท ซอฟต์ไทย แอปพลิเคชัน จำกัด (SoftThai Application Co., Ltd.)",
      en: "SoftThai Application Co., Ltd.",
    },
    duration: {
    ...
    responsibility: {
      th: "ในระหว่างการฝึกงานที่ผ่านมา ฉันได้พัฒนาและนำเข้าระบบบันทึกความเคลื่อนไหวทางบัญชีของบริษัท นอกจากนี้ ฉันยังได้เรียนรู้เกี่ยวกับแง่มุมของงานหลังบ้าน (back-end) และงานหน้าบ้าน (front-end) รวมถึงการทำงานร่วมกันเป็นทีมสำหรับสายงานนี้",
      en: "In my past internship, I developed and implemented the company's accounting movement system. In addition, I learned about both back-end and front-end aspects of teamwork for working in this line of work.",
    },
    futurePlan: {
      th: "ฉันเลือกที่จะเข้าร่วมฝึกงานต่อไป ฉันต้องการได้รับประสบการณ์การทำงานจริง ฝึกทักษะการทำงานเป็นทีม ได้รับความท้าทายจากการพบเจอสิ่งใหม่ๆ และฝึกทักษะการสื่อสารให้ดียิ่งขึ้น",
      en: "I chose to continue my internship. I wanted to gain real work experience and practice my teamwork skills, be challenged by encountering new things, and practice my communication skills even more.",
    },
  },
  activities: [
    {
      title: {
        ...
        en: "Five Campuses Sports Project at Prince of Songkla University, Hat Yai Campus.",
      },
      date: {
        th: "5 - 7 กันยายน 2567",
